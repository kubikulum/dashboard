 ...
 */
export interface IoXK8sClusterV1beta1ClusterClassSpecVariablesInnerSchemaOpenAPIV3SchemaXKubernetesValidationsInner { 
    /**
     ...
     */
    reason?: IoXK8sClusterV1beta1ClusterClassSpecVariablesInnerSchemaOpenAPIV3SchemaXKubernetesValidationsInnerReason;
    /**
...
export enum IoXK8sClusterV1beta1ClusterClassSpecVariablesInnerSchemaOpenAPIV3SchemaXKubernetesValidationsInnerReason {
    FIELD_VALUE_INVALID = 'FieldValueInvalid',
    FIELD_VALUE_FORBIDDEN = 'FieldValueForbidden',
    FIELD_VALUE_REQUIRED = 'FieldValueRequired',
    FIELD_VALUE_DUPLICATE = 'FieldValueDuplicate'
};
