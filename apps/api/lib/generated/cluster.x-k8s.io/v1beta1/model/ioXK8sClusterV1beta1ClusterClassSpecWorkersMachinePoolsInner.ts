 ...
 */
import { IoXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInnerNamingStrategy } from './ioXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInnerNamingStrategy';
import { IoXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInnerTemplate } from './ioXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInnerTemplate';


/**
 * MachinePoolClass serves as a template to define a pool of worker nodes of the cluster provisioned using `ClusterClass`.
 */
export interface IoXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInner { 
    /**
    ...
    namingStrategy?: IoXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInnerNamingStrategy;
    /**
    ...
    template: IoXK8sClusterV1beta1ClusterClassSpecWorkersMachinePoolsInnerTemplate;
}
