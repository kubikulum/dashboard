 ...
 */
import { CreateHookRequestConfig } from './createHookRequestConfig';
...
export interface UpdateHookRequest { 
     ...
     * Use `events` instead.
     */
    event?: UpdateHookRequest.EventEnum | null;
    /**
     * An array of updated hook events.
     */
    events?: Array<UpdateHookRequest.EventsEnum>;
    config?: CreateHookRequestConfig;
    enabled?: boolean;
    createdAt?: number;
}
export namespace UpdateHookRequest {
