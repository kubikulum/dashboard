...
@InputType()
class InvitationCreateNestedManyWithoutOrganizationsInput {
...
export { InvitationCreateNestedManyWithoutOrganizationsInput as InvitationCreateNestedManyWithoutOrganizationsInput };
