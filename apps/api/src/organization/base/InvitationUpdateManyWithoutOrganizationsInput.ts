...
@InputType()
class InvitationUpdateManyWithoutOrganizationsInput {
...
export { InvitationUpdateManyWithoutOrganizationsInput as InvitationUpdateManyWithoutOrganizationsInput };
